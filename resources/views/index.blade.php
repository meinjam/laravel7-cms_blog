...
<head lang="en">
    ...
    <title>{{ $settings->site_name }} - Index Page</title>

    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/fonts.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/crumina-fonts.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/normalize.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/grid.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/styles.css') }}">


    <!--Plugins styles-->

    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/jquery.mCustomScrollbar.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/swiper.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/primary-menu.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/app/css/magnific-popup.css') }}">
            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <a href="{{ asset($post->image) }}" class="link-image js-zoom-image">
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ asset($secondpost->image) }}" alt="{{ $secondpost->title }}">
                            <div class="overlay"></div>
                            <a href="{{ asset($secondpost->image) }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <div class="overlay"></div>
                            <a href="{{ asset($thirdpost->image) }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $cat_bootstrap->name }}</h4>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $cat_laravel->name }}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $cat_wordpress->name }}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">741 New Market</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="{{ asset('frontend/app/js/jquery-2.1.4.min.js') }}"></script>
<script src="{{ asset('frontend/app/js/crum-mega-menu.js') }}"></script>
<script src="{{ asset('frontend/app/js/swiper.jquery.min.js') }}"></script>
<script src="{{ asset('frontend/app/js/theme-plugins.js') }}"></script>
<script src="{{ asset('frontend/app/js/main.js') }}"></script>
<script src="{{ asset('frontend/app/js/form-actions.js') }}"></script>

<script src="{{ asset('frontend/app/js/velocity.min.js') }}"></script>
<script src="{{ asset('frontend/app/js/ScrollMagic.min.js') }}"></script>
<script src="{{ asset('frontend/app/js/animation.velocity.min.js') }}"></script>
